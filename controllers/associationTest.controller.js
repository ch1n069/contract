...
async function association(req, res) {
  ...
  const user = await models.Contract.findAll({
    include: [
      { model: models.CommissionRate, as: "commissionRates" },
      { model: models.University, as: "university" },
    ],
  });
